    ...
    <main className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="mb-8">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-700">
          Complete your profile in five guided steps. Your documents and details are securely stored, then tagged by
          initial screening rules before counselor review.
        </p>
      </section>
